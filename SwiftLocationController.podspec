#
#  Be sure to run `pod spec lint SwiftLocationController.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "" => "omer.gulzar@gmail.com" }
  # Or just: s.author    = ""
  ...
  s.source       = { :git => "https://github.com/omergulzar2/SwiftLocationController.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "Classes", "SwiftLocationController/*.{h,m,swift}"
